        ...
        <form action="#" method="GET" class="md:hidden mb-2">
          ...
          <ul class="space-y-2">
            ...
            <li>
              ...
              <ul id="dropdown-hrms-main" class="py-2 space-y-2">
                <li>
                  <NuxtLink
                    to="/hrms"
            ...
            <li>
              ...
              <ul id="dropdown-inventorywarehouse-main" class="py-2 space-y-2">
              </ul>
            </li>
            <hr class="h-px my-8 bg-gray-200 border-0 dark:bg-gray-700">
            <!-- Accounting -->
            <li>
              ...
              <ul id="dropdown-accounting-main" class="py-2 space-y-2">
              </ul>
            </li>
            <hr class="h-px my-8 bg-gray-200 border-0 dark:bg-gray-700">
            <!-- Project Monitoring -->
