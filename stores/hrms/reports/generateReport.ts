...
export const FAILURE_TO_LOG_MONITORING = "FAILURE TO LOG MONITORING"
export const FAILURE_TO_LOG_MONITORING_SUMMARY = "FAILURE TO LOG MONITORING SUMMARY"
export const OVERTIME_MONITORING_SUMMARY = "OVERTIME MONITORING SUMMARY"
export const SALARY_MONITORING = "SALARY MONITORING"
export const LEAVE_MONITORING = "LEAVE MONITORING"
export const LEAVE_MONITORING_SUMMARY = "LEAVE MONITORING SUMMARY"
export const TRAVEL_ORDER_MONITORING = "TRAVEL ORDER MONITORING"
export const TRAVEL_ORDER_MONITORING_SUMMARY = "TRAVEL ORDER MONITORING SUMMARY"
export const MANPOWER_REQUEST_MONITORING = "MANPOWER REQUEST MONITORING"
export const MANPOWER_REQUEST_MONITORING_SUMMARY = "MANPOWER REQUEST MONITORING SUMMARY"
export const PAN_TERMINATION_MONITORING = "PAN TERMINATION MONITORING"
export const PAN_PROMOTION_MONITORING = "PAN PROMOTION MONITORING"
export const PAN_TRANSFER_MONITORING = "PAN TRANSFER MONITORING"
export const ATTENDANCE_LOG_MONITORING = "ATTENDANCE LOG MONITORING"
export const ATTENDANCE_LOG_MONITORING_SUMMARY = "ATTENDANCE LOG MONITORING SUMMARY"
export const MONITORING_REPORTS = [
    OVERTIME_MONITORING,
    SALARY_MONITORING,
]
export const CATEGORY_FILTER_MONITORING_REPORTS = [
    OVERTIME_MONITORING,
...
export const DATE_FILTER_MONITORING_REPORTS = [
    OVERTIME_MONITORING,
    OVERTIME_MONITORING_SUMMARY,
    FAILURE_TO_LOG_MONITORING,
    FAILURE_TO_LOG_MONITORING_SUMMARY,
