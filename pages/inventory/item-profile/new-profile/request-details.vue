...
<template>
    ...
    >
        <template v-if="validKey">
            <InventoryItemProfileDetails title="Item Profile Details" :data="page.list.item_profile" :data-approval="page.list.approvals" :next-approval="page.list" :header-columns="headers" />
        </template>
        <template v-else>
