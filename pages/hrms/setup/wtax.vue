...
const headers: Header[] = [
      ...
      { text: "Employee Share", value: "salary_base" },
      { text: "Total Contributions", value: "tax_amount" },
...
const submitAdd = () => {
  ...
  // obj.salary_range_to = addItem.salary_range_to;
  // obj.salary_base = addItem.salary_base;
  // obj.tax_amount = addItem.tax_amount;
  // obj.over_salary_base = addItem.over_salary_base;
  // obj.id = addItem.id;
};
...
const clear = () => {
    addItem.term = "";
    addItem.status = "";
    addItem.compensation_range = "";
    addItem.salary_range_from = "";
    addItem.salary_range_to = "";
    addItem.salary_base = "";
    addItem.tax_amount = "";
    addItem.over_salary_base = "";
    addItem.id = 0;
};
</script>
...
<template>
  ...
  <div class="mt-5 flex gap-7">
    <div class="w-2/5">
      <div class="edit-item w-full max-w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 p-6 overflow-auto" >
          ...
          <div class="mb-6">
              ...
              <select v-model="addItem.term" id="term" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
          ...
          <div class="mb-6">
              <div class="grid gap-6 mb-6 md:grid-cols-2">
                <div>
                  ...
                  <input v-model="addItem.salary_range_from" type="text" id="salary_range_from" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" required>
                </div>
                <div>
                  <label for="salary_range_to" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Salary Range To</label>
                  <input v-model="addItem.salary_range_to" type="text" id="salary_range_to" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" required>
                </div>
              </div>
          </div> 
          <div class="mb-6">
              <label for="wtax_amt" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Wtax Amount</label>
              <input v-model="addItem.tax_amount" type="text" id="wtax_amt" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" required>
          </div> 
          <div class="mb-6">
              <label for="wtax_percent" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Wtax Percent Overbase</label>
              <input v-model="addItem.over_salary_base" type="text" id="wtax_percent" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" required>
          </div> 
          <div class="flex flex-row gap-5">
            ...
            <div>
              <button @click="clear()" type="submit" class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Clear</button>
            </div>
          </div>
      </div>
    </div>
    <div class="w-3/5">
      <div class="w-full">
        <div class="w-full" id="accordion-color" data-accordion="collapse" data-active-classes="bg-blue-100 dark:bg-gray-800 text-blue-600 dark:text-white">
          <h2 id="ac-heading-1">
            <button type="button" class="flex items-center justify-between w-full p-5 font-medium rtl:text-right text-gray-500 border border-b-0 border-gray-200 focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-800 dark:border-gray-700 dark:text-gray-400 hover:bg-blue-100 dark:hover:bg-gray-800 gap-3" data-accordion-target="#ac-1" aria-expanded="false" aria-controls="ac-1">
              <span>WTAX Table (Daily)</span>
          ...
          <h2 id="accordion-color-heading-3">
            <button type="button" class="flex items-center justify-between w-full p-5 font-medium rtl:text-right text-gray-500 border border-b-0 border-gray-200 focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-800 dark:border-gray-700 dark:text-gray-400 hover:bg-blue-100 dark:hover:bg-gray-800 gap-3" data-accordion-target="#accordion-color-body-3" aria-expanded="false" aria-controls="accordion-color-body-3">
              <span>WTAX Table (Semi-monthly)</span>
              <svg data-accordion-icon class="w-3 h-3 rotate-180 shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5 5 1 1 5"/>
              </svg>
            </button>
