<template>
    <div class="flex flex-col gap-4">
        ...
        <div v-if="projectStore.information.stage.toLowerCase() !== projectStore.stages[projectStore.stages.length - 1].toLowerCase()" class="flex justify-end gap-4 items-center pb-6">
