...
<template>
    ...
    >
        <div class="md:w-1/4">
            <img
                v-if="lastSuccessLogEmployee?.employee?.profile_photo && lastSuccessLogEmployee?.employee?.profile_photo.base64 && lastSuccessLogEmployee?.employee?.profile_photo.base64 !== 'File doesn\'t exists.'"
