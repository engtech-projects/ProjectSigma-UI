...
const addItem = () => {
    stockTransfer.value.items.push(
        {
            qty: "",
            unit: "",
            item_id: "",
...
const removeItem = (id: number) => {
    stockTransfer.value.items.splice(id, 1)
}
</script>
<template>
            ...
            <div id="content" class="overflow-auto max-h-96">
                <table class="table-auto w-full border-collapse">
                    ...
                    <tbody>
                        ...
                        <template v-for="(item, index) in stockTransfer.items" :key="index">
                            <InventoryStockTransferItemAppend
                                v-model:item="stockTransfer.items[index]"
                                :index="index"
