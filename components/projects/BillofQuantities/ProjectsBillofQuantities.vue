<template>
    <div>
                            ...
                            <td class="border border-gray-700">
                                <div class="flex">
                                    ...
                                    <div class="flex flex-col p-2 justify-center gap-2">
                                        <NuxtLink v-if="edit" :to="`/project-monitoring/project-details?id=${task.id}&&pid=${props.projectId}`" class="bg-green-500 hover:bg-green-600 active:bg-green-700 select-none text-white rounded-md text-xs w-6 h-6">
        ...
        <LayoutPrint v-if="print">
            <ProjectsPrintCpaBillOfQuantities />
        </LayoutPrint>
