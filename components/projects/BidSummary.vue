        ...
        <table class="w-full border-collapse border border-black mb-6">
            <tr class="bg-yellow-200 border border-black">
                <th class="text-center align-middle p-2" colspan="3">
                    <p>
                        <span class="font-semibold">ABC =</span> 96,500,000.00
                    </p>
                </th>
            </tr>
            <tr class="bg-yellow-200 border border-black">
            ...
            <tr class="border border-black">
                <td class="p-2" colspan="2">
                    ...
                    <p class="pl-6">
                        ninety-five million six hundred fifty-one thousand six hundred five and ninety-eight hundredths
                    </p>
                </td>
            </tr>
        </table>
