<template>
    <nav class="exclude-from-print bg-white border-b border-gray-200 px-4 py-2.5 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50">
        <div class="flex flex-wrap justify-between items-center">
            <div class="flex justify-start items-center">
                <button data-drawer-target="drawer-navigation" data-drawer-toggle="drawer-navigation" aria-controls="drawer-navigation" class="p-2 mr-2 text-gray-600 rounded-lg cursor-pointer md:hidden hover:text-gray-900   focus:bg-gray-100 dark:focus:bg-gray-700 focus:ring-2 focus:ring-gray-100 dark:focus:ring-gray-700 dark:text-gray-400   dark:hover:text-white">
                    <svg
                        aria-hidden="true"
                        class="w-6 h-6"
                        fill="currentColor"
                ...
                <a href="/hrms" class="flex items-center justify-between mr-4">
            ...
            <div class="flex items-center lg:order-2">
                ...
                <div id="user-menu-button" class="hidden z-50 my-4 w-56 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600 rounded-xl">
                    <div class="py-3 px-4">
                        <span
                    ...
                    <ul class="py-1 text-gray-700 dark:text-gray-300" aria-labelledby="dropdown">
                        <li>
                            <a href="#" class="flex items-center py-2 px-4 text-sm dark:hover:bg-gray-600 dark:hover:text-white">
                                <svg
                        ...
                        <li>
                            <a href="#" class="flex justify-between items-center py-2 px-4 text-sm   dark:hover:bg-gray-600 dark:hover:text-white">
