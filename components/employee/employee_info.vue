        ...
        <table class="w-full border-collapse border border-slate-300 table-fixed">
            <tbody>
                ...
                <td>
                  <div class="p-1">
                    <label for="employee_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Generate Employee ID</label>
                      <div class="relative">
                        <input type="text" id="small-input" class="block w-full p-1 text-gray-900 border border-gray-300 rounded-md bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Employee ID" required>
              ...
              <tr v-for="(child, index) in children" :key="index">
                ...
                <td colspan="2" class="border border-slate-300 p-1">
                  ...
                  <div class="flex">
                    ...
                    <button class="delete-button" @click.prevent="deleteChild(index)" v-if="index > 0"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-red-600"><path stroke-linecap="round" stroke-linejoin="round" d="M15 12H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z" /></svg></button>
              ...
              <tr>
                ...
                <td class="border border-slate-300 p-1">
                  <div>
                    <label for="small-input" class="inline text-[11px] w-32 font-medium text-gray-900 dark:text-white">PREVIOUS OPERATION</label>
                  </div>
                </td>
                <td class="border border-slate-300 p-1">
                  <div>
              ...
              <tr>
                <td class="border border-slate-300 p-1">
                  <div>
                    <label for="small-input" class="inline text-[11px] w-32 font-medium text-gray-900 dark:text-white">CURRENTLY UNDERGOING TREATMENT?</label>
                ...
                <td class="border border-slate-300 p-1">
                  <div>
                    <label for="small-input" class="inline text-[11px] w-32 font-medium text-gray-900 dark:text-white">HAVE YOU EVER BEEN CONVICTED OF A CRIME?</label>
                  </div>
                </td>
                <td class="border border-slate-300 p-1">
                  <div>
              ...
              <tr>
                <td colspan=1 class="border border-slate-300 p-1">
                  <div>
                    <label for="small-input" class="inline text-[11px] w-32 font-medium text-gray-900 dark:text-white">HAVE YOU BEEN DISMISSED, RESIGNED FROM, OR LEFT EMPLOYMENT DUE TO ALLEGATION OF MISCONDUCT?</label>
                  </div>
                </td>
              ...
              <tr>
                <td colspan=1 class="border border-slate-300 p-1">
                  <div>
                    <label for="small-input" class="inline text-[11px] w-32 font-medium text-gray-900 dark:text-white">DO YOU HAVE ANY PENDING ADMINISTRATIVE OR CRIMINAL CASE?</label>
                  </div>
                </td>
                <td colspan=3 class="border border-slate-300 p-1">
                  <div>
              ...
              <tr v-for="(relative, index) in relatives" :key="index">
                ...
                <td class="border border-slate-300 p-1">
                  ...
                  <div class="flex">
                    ...
                    <button class="delete-button" @click.prevent="deleteRelative(index)" v-if="index > 0"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-red-600"><path stroke-linecap="round" stroke-linejoin="round" d="M15 12H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z" /></svg></button>
