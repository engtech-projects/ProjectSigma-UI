                ...
                <tr>
                    ...
                    <td class="border border-slate-300 p-1">
                        <div>
                            ...
                            <input id="prev_hosp" type="text" class="block w-full h-16 p-1 text-gray-900 border border-gray-300 rounded-md bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="IF YES, NATURE OF ILLNESS">
                        </div>
                    </td>
                    <td class="border border-slate-300 p-1">
                        <div>
                    ...
                    <td class="border border-slate-300 p-1">
                        <div>
                            <label for="small-input" class="block mb-2 text-[11px] font-medium text-gray-900 dark:text-white" />
                            <input id="prev_op" type="text" class="block w-full h-16 p-1 text-gray-900 border border-gray-300 rounded-md bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="IF YES, NATURE OF ILLNESS">
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="border border-slate-300 p-1">
                        <div>
                            <label for="small-input" class="block mb-2 text-[11px] font-medium text-gray-900 dark:text-white" />
                            <input id="current_treatment" type="text" class="block w-full h-16 p-1 text-gray-900 border border-gray-300 rounded-md bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="IF YES, NATURE OF ILLNESS">
                        </div>
                    </td>
                    <td class="border border-slate-300 p-1">
                        <div>
