<template>
    ...
    <div class="edit-item w-full max-w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 p-6 overflow-auto" >
          ...
          <div class="mb-6">
              ...
              <select disabled v-model="editingItem.term" id="term" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
          ...
          <div class="mb-6">
              <div class="grid gap-6 mb-6 md:grid-cols-2">
                <div>
                  ...
                  <input v-model="editingItem.salary_range_from" type="text" id="salary_range_from" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" required>
                </div>
                <div>
                  <label for="salary_range_to" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Salary Range To</label>
                  <input v-model="editingItem.salary_range_to" type="text" id="salary_range_to" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" required>
                </div>
              </div>
          </div> 
          <div class="mb-6">
              <label for="wtax_amt" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Wtax Amount</label>
              <input v-model="editingItem.tax_amount" type="text" id="wtax_amt" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" required>
          </div> 
          <div class="mb-6">
              <label for="wtax_percent" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Wtax Percent Overbase</label>
              <input v-model="editingItem.over_salary_base" type="text" id="wtax_percent" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" required>
          </div> 
