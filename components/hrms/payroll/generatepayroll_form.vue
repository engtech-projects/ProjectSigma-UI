<template>
    <div>
        <div class="mt-5 w-full max-w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 p-6 overflow-auto" >
            ...
            <div class="mb-5 grid grid-cols-1 gap-6 sm:grid-cols-2">
                <div>
                    ...
                    <select id="cutoff_dates" name="cutoff_dates" class="block w-full p-1 text-gray-900 border border-gray-300 rounded-md bg-gray-50 dark:text-gray-400 dark:bg-gray-700 dark:border-gray-600 focus:outline-none dark:placeholder-gray-400 text-sm">
                        ...
                        <div class="mt-4 flex flex-col">
                            <div class="mb-5 grid grid-cols-1 gap-6 sm:grid-cols-4">
                                ...
                                <div>
                                    ...
                                    <button type="submit" class="min-w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add</button>
                                </div>
                            </div>
                        </div>
                    </div>
