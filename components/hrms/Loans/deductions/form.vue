<template>
  <div class="md:mt-0 edit-item w-full max-w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 p-6 overflow-auto" >
    ...
    <div class="mt-3 grid grid-cols-1 gap-4 sm:grid-cols-2">
      <div>
        <label for="employee_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Deduction Name</label>
    ...
    <div class="mt-3 grid grid-cols-1 gap-6 sm:grid-cols-2">
      <div>
        <label for="department" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Deduction Description</label>
        <input disabled readonly type="text" id="department" class="cursor-not-allowed bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
      </div>
      <div>
        <label for="date_fill" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Deduction Start</label>
        <input type="date" id="date_fill" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
      </div>
      <!-- <div>
    ...
    <div class="mt-3 grid grid-cols-1 gap-6 sm:grid-cols-2">
        ...
        <div>
          <label for="position" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Duration (Months)</label>
    ...
    <EasyDataTable
      ...
      :items="items">
            <template #item-name="item" >
              <div v-for="(data, index) in AddItem" :key="index" class="flex flex-row gap-5">
                <div class="flex-grow shrink-0">
                  <input v-model="data.name" placeholder="" type="text" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                </div>
              </div>
            </template>
            <template #item-atd="item" >
              <div v-for="(data, index) in AddItem" :key="index" class="flex flex-row gap-5">
                <div class="flex-grow shrink-0">
                  <input v-model="data.atd" placeholder="" type="text" id="atd" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                </div>
              </div>
            </template>
            <template #item-dpt="item" >
              <div v-for="(data, index) in AddItem" :key="index" class="flex flex-row gap-5">
                <div class="flex-grow shrink-0 flex flex-row gap-2">
                  <input v-model="data.dpt" placeholder="" type="text" id="type" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                </div>
              </div>
            </template>
    ...
    <div class="max-w-full flex flex-row-reverse mt-5">
      ...
      <button @click="submitAdd" type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"><Icon name="ic:baseline-add" class="w-4 h-4 " fill="currentColor"/> Add</button>
    </div>
  </div>
</template>
...
const headers: Header[] = [
  ...
  {
    text: "Amount to deduct", value: "atd",
  },
  {
    text: "Deduction per term", value: "dpt",
  },
  {
    text: "", value: "actions",
  }
