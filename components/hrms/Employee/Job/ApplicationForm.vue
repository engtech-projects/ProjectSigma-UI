...
const { jobapplicant, errorMessage, successMessage, addJobApplicantRequest } = storeToRefs(jobapplicantstore)
...
<template>
    <div class="relative">
        <div v-if="addJobApplicantRequest.isLoading" class="absolute bg-slate-200/50 rounded-lg w-full h-full flex items-center justify-center">
            <img
