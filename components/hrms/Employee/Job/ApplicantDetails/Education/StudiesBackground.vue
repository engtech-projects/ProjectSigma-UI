...
const studiesEducation = computed(() => {
    if (!props.applicant?.education) { return null }
    return props.applicant.education.find(edu => edu.type === "graduate_studies") || null
})
</script>
<template>
        ...
        <table class="w-full border-collapse border border-slate-400 table-fixed">
            <tbody>
                <tr v-if="studiesEducation">
                    ...
                    <td colspan="2" class="border border-slate-300 p-1">
                        <div>
                            ...
                            <input
                                id="master_title"
                                v-model="studiesEducation.title"
                                type="text"
                ...
                <tr>
                    ...
                    <td class="border border-slate-300 p-1 justify-center">
