...
const collegeEducation = computed(() => {
    if (!props.applicant?.education) { return null }
    return props.applicant.education.find(edu => edu.type === "elementary") || null
})
</script>
<template>
                    ...
                    <td class="border border-slate-300 p-1">
                        ...
                        <div class="flex">
                            <input
                                ...
                                v-model="collegeEducation.degree_earned_of_school"
                                type="text"
                                class="block w-full p-1 text-gray-900 border border-gray-300 rounded-md bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            >
                        </div>
                        ...
                        <div class="p-1">
                            ...
                            <div class="flex justify-center">
                                <input
                                    ...
                                    v-model="collegeEducation.period_attendance_from"
                                    type="text"
                                    class="block w-full p-1 text-gray-900 border border-gray-300 rounded-md bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                >
                                -
                                <input
                                    ...
                                    v-model="collegeEducation.period_attendance_to"
                                    type="text"
                                    class="block w-full p-1 text-gray-900 border border-gray-300 rounded-md bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                >
                            </div>
                    ...
                    <td class="border border-slate-300 p-1">
                        ...
                        <div class="flex">
                            <input
                                ...
                                v-model="collegeEducation.honors_received"
                                type="text"
                                class="block w-full p-1 text-gray-900 border border-gray-300 rounded-md bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            >
                        </div>
                    ...
                    <td class="border border-slate-300 p-1">
                        ...
                        <div class="flex">
                            <input
                                ...
                                v-model="collegeEducation.year_graduated"
                                type="text"
                                class="block w-full p-1 text-gray-900 border border-gray-300 rounded-md bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            >
                        </div>
