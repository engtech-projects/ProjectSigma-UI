...
const handleDocumentUpload = async (event) => {
    try {
        ...
        formData.append("upload_type", "Memo")
            ...
            <Teleport to="body">
                ...
                <div class="fixed inset-1 flex items-center justify-center">
                    <div class="bg-white p-4 max-w-lg rounded-lg border border-slate-300">
                        ...
                        <hr>
                        <ul class="mt-4 p-4">
                            <li><strong class="text-teal-500">Document Name:</strong> {{ selectedItemDetailsMemo.employee_uploads }}</li>
                            <li><strong class="text-teal-500">Type:</strong> {{ selectedItemDetailsMemo.upload_type }}</li>
                        </ul>
