<template>
    <form v-for="(emprecord, index) in emprecords" :key="index" action="">
        <div class="flex items-center justify-end">
            ...
            <button v-if="index === emprecords.length - 1" class="add-button" @click="addEmprecords">
                <span class="text-green-500 hover:text-green-700">Add Membership Record</span>
            </button>
        </div>
            ...
            <tbody>
                <tr>
                    <td class="border border-slate-300 p-1">
                        <label for="incdates" class="block mb-2 text-[11px] w-32 font-medium text-gray-900 dark:text-white">ORGANIZATION/CLUB</label>
                    ...
                    <td class="border border-slate-300 p-1">
                        <label for="superior_name" class="block mb-2 text-[11px] font-medium text-gray-900 dark:text-white">POSITION</label>
