...
const addParams = () => {
    information.value.employee_education_vocationalcourse = {
        id: null,
        name: null,
        education: null,
...
<template>
    ...
    <LayoutBoards title="" class="w-full" :loading="boardLoading">
        <table class="w-full border-collapse border border-slate-400 table-fixed">
            <tbody>
                <tr v-if="information.employee_education_vocationalcourse">
                    <td class="border border-slate-300 p-1">
                        <p for="vocational_name" class="block mb-2 text-[11px] font-medium text-gray-900 dark:text-white">
                            NAME OF SCHOOL
                        </p>
                        <div class="flex">
                    ...
                    <td class="border border-slate-300 p-1">
                        <p for="vocational_degree_earned_of_school" class="block mb-2 text-[11px] font-medium text-gray-900 dark:text-white">
                            DEGREE EARNED
                        </p>
                        <div class="flex">
                    ...
                    <td class="border border-slate-300">
                        <div class="p-1">
                            <p for="vocational_period_attendance_from" class="block mb-2 text-[11px] font-medium text-gray-900 dark:text-white">
                                INCLUSIVE DATES
                            </p>
                            <div class="flex justify-center">
                                <input id="vocational_period_attendance_from" v-model="information.employee_education_vocationalcourse.period_attendance_from" type="text" class="block w-36 p-1 text-gray-900 border border-gray-300 rounded-md bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                -
                                <input id="vocational_period_attendance_to" v-model="information.employee_education_vocationalcourse.period_attendance_to" type="text" class="block w-36 p-1 text-gray-900 border border-gray-300 rounded-md bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            </div>
                        </div>
                    </td>
                    <td class="border border-slate-300 p-1">
                        <p for="vocational_honors_received" class="block mb-2 text-[11px] font-medium text-gray-900 dark:text-white">
                            HONORS RECEIVED
                        </p>
                        <div class="flex">
                    ...
                    <td class="border border-slate-300 p-1">
                        <p for="vocational_year_graduated" class="block mb-2 text-[11px] font-medium text-gray-900 dark:text-white">
                            YEAR GRADUATED
                        </p>
                        <div class="flex">
                    ...
                    <td v-if="editable" class="border border-slate-300 p-1 justify-center">
                        <div class="w-full flex gap-2">
                            <button
                                v-if="!information.employee_education_vocationalcourse.id"
                                class=" bg-green-600 text-white w-7 h-7"
                                @click="saveEmployeeSchool(information.employee_education_vocationalcourse)"
                            >
                            ...
                            <button
                                ...
                                @click="updateEmployeeSchool(information.employee_education_vocationalcoursecourse.id, information.employee_education_vocationalcourse)"
                            >
                            ...
                            <button
                                ...
                                @click="deleteEmployeeSchool(information.employee_education_vocationalcourse.id)"
                            >
