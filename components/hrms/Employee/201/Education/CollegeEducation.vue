                    ...
                    <td class="border border-slate-300">
                        <div class="p-1">
                            ...
                            <div class="flex justify-center">
                                ...
                                -
                                <input id="elementary_period_attendance_to" v-model="information.employee_education_college.period_attendance_to" type="text" class="block w-36 p-1 text-gray-900 border border-gray-300 rounded-md bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            </div>
                        </div>
                    </td>
                    <td class="border border-slate-300 p-1">
