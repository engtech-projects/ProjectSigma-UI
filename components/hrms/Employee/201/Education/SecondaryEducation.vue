...
const addParams = () => {
    information.value.employee_education_secondary = {
        id: null,
        name: null,
        education: null,
...
<template>
    ...
    <LayoutBoards title="" class="w-full" :loading="boardLoading">
        <table class="w-full border-collapse border border-slate-400 table-fixed">
            <tbody>
                <tr v-if="information.employee_education_secondary">
                    <td class="border border-slate-300 p-1">
                        ...
                        <div class="flex">
                            <input
                                id="elementary_name"
                                v-model="information.employee_education_secondary.name"
                                type="text"
                                :disabled="!editable"
                    ...
                    <td class="border border-slate-300 p-1">
                        ...
                        <div class="flex">
                            <input
                                id="elementary_degree_earned_of_school"
                                v-model="information.employee_education_secondary.degree_earned_of_school"
                                type="text"
                                :disabled="!editable"
                                class="block w-full p-1 text-gray-900 border border-gray-300 rounded-md bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            >
                    ...
                    <td class="border border-slate-300">
                        <div class="p-1">
                            ...
                            <div class="flex justify-center">
                                <input
                                    id="elementary_period_attendance_from"
                                    v-model="information.employee_education_secondary.period_attendance_from"
                                    type="text"
                                    :disabled="!editable"
                                    class="block w-full p-1 text-gray-900 border border-gray-300 rounded-md bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                >
                                -
                                <input
                                    id="elementary_period_attendance_to"
                                    v-model="information.employee_education_secondary.period_attendance_to"
                                    type="text"
                                    :disabled="!editable"
                                    class="block w-full p-1 text-gray-900 border border-gray-300 rounded-md bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                >
                    ...
                    <td class="border border-slate-300 p-1">
                        ...
                        <div class="flex">
                            <input
                                id="elementary_honors_received"
                                v-model="information.employee_education_secondary.honors_received"
                                type="text"
                                :disabled="!editable"
                                class="block w-full p-1 text-gray-900 border border-gray-300 rounded-md bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            >
                    ...
                    <td class="border border-slate-300 p-1">
                        <p for="secondary_year_graduated" class="block mb-2 text-[11px] font-medium text-gray-900 dark:text-white">
                            YEAR GRADUATED
                        </p>
                        <div class="flex">
                            <input
                                id="secondary_year_graduated"
                                v-model="information.employee_education_secondary.year_graduated"
                                type="text"
                                :disabled="!editable"
                                class="block w-full p-1 text-gray-900 border border-gray-300 rounded-md bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            >
                    ...
                    <td v-if="editable" class="border border-slate-300 p-1 justify-center">
                        <div class="w-full flex gap-2">
                            <button
                                v-if="!information.employee_education_secondary.id"
                                class=" bg-green-600 text-white w-7 h-7"
                                @click="saveEmployeeSchool(information.employee_education_secondary)"
                            >
                            ...
                            <button
                                ...
                                @click="updateEmployeeSchool(information.employee_education_secondary.id, information.employee_education_secondary)"
                            >
                            ...
                            <button
                                ...
                                @click="deleteEmployeeSchool(information.employee_education_secondary.id)"
                            >
