    ...
    >
        <form @submit.prevent="handleSubmit">
            <HrmsCommonDepartmentSelector
                ...
                v-model="createModel.body.department_id"
                :title="type"
            />
            <HrmsCommonSearchEmployeeSelector
                v-else-if="type === 'Employee'"
                v-model="createModel.body.employee_id"
                :title="type"
            />
            ...
            <div class="flex md:flex justify-center mx-auto">
                <div class="p-2 gap-4 items-center">
                    ...
                    <input
                        id="eventTitleIn"
                        v-model="createModel.body.startTime"
                        type="time"
            ...
            <div class="mb-4 dark:border-gray-700">
                <div class="flex flex-wrap items-center justify-center">
                    <div v-for="(scheduleType, index) in ['Regular', 'Irregular']" :key="index" class="mt-3 mr-2">
                        <input
                            :id="scheduleType"
                            v-model="createModel.body.scheduleType"
                            :value="scheduleType"
                            type="radio"
                            class="hidden peer"
                            required
            ...
            <div id="default-tab-content">
                <div v-show="createModel.body.scheduleType === 'Regular'" id="regular" class=" p-1 rounded-lg bg-gray-50 dark:bg-gray-800">
                    ...
                    <div class="grid grid-cols-3 gap-y-2 md:flex-1 mx-auto justify-center items-center mt-5 md:gap-4 p-2 rounded-md">
                        <div class="flex">
                            <input id="monday" v-model="createModel.body.daysOfWeek" type="checkbox" value="1" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="monday" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Monday</label>
                        </div>
                        <div class="flex">
                            <input id="tuesday" v-model="createModel.body.daysOfWeek" type="checkbox" value="2" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="tuesday" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Tuesday</label>
                        </div>
                        <div class="flex">
                            <input id="wednesday" v-model="createModel.body.daysOfWeek" type="checkbox" value="3" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="wednesday" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Wednesday</label>
                        </div>
                        <div class="flex">
                            <input id="thursday" v-model="createModel.body.daysOfWeek" type="checkbox" value="4" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="thursday" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Thursday</label>
                        </div>
                        <div class="flex">
                            <input id="friday" v-model="createModel.body.daysOfWeek" type="checkbox" value="5" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="friday" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Friday</label>
                        </div>
                        <div class="flex">
                            <input id="saturday" v-model="createModel.body.daysOfWeek" type="checkbox" value="6" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="saturday" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Saturday</label>
                        </div>
                        <div class="flex">
                            <input id="sunday" v-model="createModel.body.daysOfWeek" type="checkbox" value="0" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                ...
                <div v-show="createModel.body.scheduleType === 'Irregular'" id="irregular" class=" p-1 rounded-lg bg-gray-50 dark:bg-gray-800">
