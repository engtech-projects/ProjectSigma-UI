    ...
    <div class="md:flex gap-4">
        <div class="w-full md:w-1/2 justify-start border border-teal-100 shadow-md rounded-lg mt-5 ">
            <div class="p-4">
                ...
                <select id="schedule" class="mt-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                        ...
                        <form @submit.prevent="handleSubmit" @reset="handleReset">
                            ...
                            <div class="flex md:flex justify-center mx-auto">
                                <div class="p-2  gap-4 items-center">
                                    ...
                                    <input id="eventTitleIn" type="time" name="eventTitleIn" class="w-36 md:w-32 rounded-lg">
                                </div>
                                <div class="p-2  gap-4 items-center">
                                    <label for="eventTitleOut" class="block text-xs text-center italic">Out</label>
                                    <input id="eventTitleOut" type="time" name="eventTitleOut" class="w-36 md:w-32 rounded-lg">
                                </div>
                            </div>
                            ...
                            <div id="default-tab-content">
                                <div id="regular" class="p-1 rounded-lg bg-gray-50 dark:bg-gray-800" role="tabpanel" aria-labelledby="regular-tab">
                                    ...
                                    <div class="flex md:flex justify-center mx-auto">
                                        <div class="p-2  gap-4 items-center">
                                            ...
                                            <input id="dateStart" type="date" name="dateStart" class="w-36 md:w-32 rounded-lg">
                                        </div>
                                        <div class="p-2  gap-4 items-center">
                                            <label for="dateEnd" class="block text-xs italic ml-3">Date End <b class="text-orange-500"> (optional)</b></label>
                                            <input id="eventdateEndTitleOut" type="date" name="dateEnd" class="w-36 md:w-32 rounded-lg">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div id="irregular" class="p-1 rounded-lg bg-gray-50 dark:bg-gray-800" role="tabpanel" aria-labelledby="irregular-tab">
                                    ...
                                    <VueDatePicker v-model="datePicker" multi-dates multi-dates-limit="3" class="rounded-lg" />
                                </div>
                                <div class="flex justify-end mt-4">
                                    <button type="submit" class="px-4 py-2 bg-blue-500 text-white rounded-md">
                                        Submit
                                    </button>
                                    <button type="reset" class="px-4 py-2 ml-2 bg-gray-300 text-gray-700 rounded-md">
                                        Reset
                                    </button>
                                </div>
                            </div>
