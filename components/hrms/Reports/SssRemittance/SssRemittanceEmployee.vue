            ...
            <div class="flex flex-col">
                ...
                <div class="title flex flex-col justify-center gap-1 mb-12">
                    ...
                    <span class="text-xl text-black text-center">
                        FOR THE APPLICABLE MONTH OF <span class="text-red-600 font-bold underline">{{ useMonthName(sssEmployeeRemitanceList.params.filter_month) }} {{ sssEmployeeRemitanceList.params.filter_year }}</span>
                    </span>
                </div>
