...
<template>
    <LayoutBoards title="SSS LOAN PAYMENT" :loading="loanReports.reportResult.isLoading">
        ...
        <LayoutPrint>
            <div class="flex flex-col">
                <HrmsReportsLoanReportsSssReportHeader />
                ...
                <table class="printTable border border-gray-500 mb-20">
                    ...
                    <tbody class="text-sm">
                        <tr v-for="reportData, index in loanReports.reportResult.list" :key="'sssloneemployee' + index" class="h-2">
