...
<template>
    <div
        v-if="useCheckAccessibility([AccessibilityTypes.HRMS_REPORTS_PORTALMONITORING_FAILURETOLOGSUMMARY]) || useCheckAccessibility(['AdminOnly'])"
        class="flex flex-col"
    >
        <LayoutPrint>
                    ...
                    <div class="h-full">
                        <table class="printTable table-auto border-collapse border border-gray-500">
                            ...
                            <tbody class="text-sm text-center">
                                <tr v-for="failureToLogRequest, index in portalMonitoringReports.list" :key="'FailureToLogMonitoring' + index" class="h-2">
