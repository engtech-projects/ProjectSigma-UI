...
<template>
    <LayoutBoards title="SSS Remittance Summary" :loading="sssRemittanceSummaryList.isLoading">
        <form class="md:grid grid-cols-4 gap-4 mt-5 mb-16" @submit.prevent="generateReport">
            ...
            <LayoutFormPsDateInput v-model="sssRemittanceSummaryList.params.cutoff_start" class="w-full" title="Cutoff Start" required />
            <LayoutFormPsDateInput v-model="sssRemittanceSummaryList.params.cutoff_end" class="w-full" title="Cutoff End" required />
            <button
                type="submit"
