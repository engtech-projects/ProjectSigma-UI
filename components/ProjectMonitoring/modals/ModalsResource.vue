    ...
    >
        <div class="flex flex-col p-4">
            ...
            <form @submit.prevent="handleSubmit">
                <div v-if="resourceStore.resource.resource_type === DetailedEstimatesUnitIndex.labor || resourceStore.resource.resource_type === DetailedEstimatesUnitIndex.equipment" class="grid grid-cols-2 gap-6 mb-4">
                    <div>
                        <div class="flex flex-col">
                            <label v-if="resourceStore.resource.resource_type === DetailedEstimatesUnitIndex.labor" class="text-md text-gray-700">
                                Number of Person
                            </label>
                ...
                <div class="grid grid-cols-2 gap-6 mb-4">
                    ...
                    <div>
                        <div class="flex flex-col">
                            <label v-if="resourceStore.resource.resource_type === DetailedEstimatesUnitIndex.labor || resourceStore.resource.resource_type === DetailedEstimatesUnitIndex.equipment" class="text-md text-gray-700">
                                Hourly Rate
                            </label>
                            <label v-else class="text-md text-gray-700">
                                Unit Price
                ...
                <div class="grid grid-cols-2 gap-6 mb-4">
                    ...
                    <div class="flex flex-col">
                        ...
                        <select
                            ...
                            required
                        >
                            <template v-if="resourceStore.resource.resource_type === DetailedEstimatesUnitIndex.labor || resourceStore.resource.resource_type === DetailedEstimatesUnitIndex.equipment">
                                <option value="hourly">
                                    Hourly
                                </option>
                            </template>
