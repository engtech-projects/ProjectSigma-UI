...
const { projectsApprovals, editApproval } = storeToRefs(approvals)
onMounted(() => {
    if (!projectsApprovals.value.isLoaded) {
        approvals.getProjectsApprovals()
    }
})
...
const changePaginate = (newParams) => {
    projectsApprovals.value.params.page = newParams.page ?? ""
}
</script>
<template>
    <LayoutBoards title="Approvals" class="w-full" :loading="projectsApprovals.isLoading">
        <div class="pb-2 text-gray-500">
            <table class="table-auto w-full border-collapse">
                ...
                <tbody>
                    <tr v-for="(approv, index) in projectsApprovals.list" :key="index" class="border-2 border-slate-300 ">
                        <td class="p-2">
        ...
        <div class="flex justify-center mx-auto">
            <PsCustomPagination :links="projectsApprovals.pagination" @change-params="changePaginate" />
        </div>
    </LayoutBoards>
</template>
