    ...
    <LayoutBoards class="w-full" :loading="myDisbursementApprovals.isLoading">
        ...
        >
            <div class="w-1/3 flex">
                <LayoutFormPsTextInput v-model="myDisbursementApprovals.params.key" title="DV Number/Journal Voucher Number" class="w-full" />
            </div>
            <div class="pb-2 text-gray-500 text-[12px] overflow-y-auto p-2">
                ...
                <div class="flex justify-center mx-auto">
                    <PsCustomPagination :links="myDisbursementApprovals.pagination" @change-params="changePaginate" />
                </div>
            </div>
        </LayoutAcessContainer>
    </LayoutBoards>
