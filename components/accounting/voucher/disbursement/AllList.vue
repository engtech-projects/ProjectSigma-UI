...
await voucherStore.getAllDisbursementVouchers()
    ...
    <LayoutBoards class="w-full" :loading="allDisbursementVouchers.isLoading">
        ...
        >
            <div class="w-1/3 flex">
                <LayoutFormPsTextInput v-model="allDisbursementVouchers.params.key" title="DV Number/Journal Voucher Number" class="w-full" />
            </div>
            <div class="pb-2 text-gray-500 text-[12px] overflow-y-auto p-2">
                ...
                <div class="flex justify-center mx-auto">
                    <PsCustomPagination :links="allDisbursementVouchers.pagination" @change-params="changePaginate" />
                </div>
            </div>
        </LayoutAcessContainer>
    </LayoutBoards>
