<template>
  <div class="mb-4 border-b border-gray-200 dark:border-gray-700">
    <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" :id="tabsId" :data-tabs-toggle="tabsContentId" role="tablist">
  ...
  <div :id="tabsContentId">
    ...
    >
      <slot :name="tab.id" v-if="index === activeTabIndex" />
    </div>
  </div>
</template>
