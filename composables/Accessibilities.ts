...
export enum AccessibilityTypes {
    ...
    HRMS_LOANSANDADVANCES_LOANS_GROUP = "hrms:loans and advances_loans_",
    HRMS_LOANSANDADVANCES_LOANS_FORMS = "hrms:loans and advances_loans_forms",
    HRMS_LOANSANDADVANCES_LOANS_ALL = "hrms:loans and advances_loans_all list",
    HRMS_LOANSANDADVANCES_LOANS_ONGOING = "hrms:loans and advances_loans_ongoing list",
    HRMS_LOANSANDADVANCES_LOANS_PAID = "hrms:loans and advances_loans_paid list",
    HRMS_LOANSANDADVANCES_LOANS_PAYMENTS = "hrms:loans and advances_loans_payments list",
    HRMS_LOANSANDADVANCES_LOANS_MAKEPAYMENTS = "hrms:loans and advances_loans_make payments",
    HRMS_LOANSANDADVANCES_OTHERDEDUCTIONS_GROUP = "hrms:loans and advances_other deductions_",
    HRMS_LOANSANDADVANCES_OTHERDEDUCTIONS_FORMS = "hrms:loans and advances_other deductions_forms",
    HRMS_LOANSANDADVANCES_OTHERDEDUCTIONS_ALL = "hrms:loans and advances_other deductions_all list",
    HRMS_LOANSANDADVANCES_OTHERDEDUCTIONS_ONGOING = "hrms:loans and advances_other deductions_ongoing list",
    HRMS_LOANSANDADVANCES_OTHERDEDUCTIONS_PAID = "hrms:loans and advances_other deductions_paid list",
    HRMS_LOANSANDADVANCES_OTHERDEDUCTIONS_PAYMENTS = "hrms:loans and advances_other deductions_payments list",
    HRMS_LOANSANDADVANCES_OTHERDEDUCTIONS_MAKEPAYMENT = "hrms:loans and advances_other deductions_make payment",
    ...
    INVENTORY_PROCUREMENT_PROCUREMENTREQUESTS_REQUESTLISTALL = "inventory:procurement_procurement request_request list all",
    INVENTORY_PROCUREMENT_PROCUREMENTREQUESTS_REQUESTLISTONGOING = "inventory:procurement_procurement request_request list ongoing",
    INVENTORY_PROCUREMENT_PROCUREMENTREQUESTS_SETCANVASSER = "inventory:procurement_procurement request_set canvasser",
    INVENTORY_PROCUREMENT_PROCUREMENTREQUESTS_PRICEQUOTATION = "inventory:procurement_procurement request_price quotations_create and view",
    INVENTORY_PROCUREMENT_PROCUREMENTREQUESTS_CANVASSSUMMARY = "inventory:procurement_procurement request_canvass summary_create and view",
    INVENTORY_PROCUREMENT_PROCUREMENTREQUESTS_PURCHASEORDER_ALLLIST = "inventory:procurement_purchase order_all list",
    INVENTORY_PROCUREMENT_PROCUREMENTREQUESTS_PURCHASEORDER_CREATENCPO = "inventory:procurement_purchase order_create ncpo",
