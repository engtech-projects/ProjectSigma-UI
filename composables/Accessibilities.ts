...
export enum AccessibilityTypes {
    ...
    INVENTORY_REQUESTSTOCK_GROUP = "inventory:request stock_",
    INVENTORY_REQUESTSTOCK_FORM = "inventory:request stock_form and my requests",
    INVENTORY_REQUESTSTOCK_ALLREQUESTS = "inventory:request stock_all requests",
    INVENTORY_REQUESTSTOCK_MYAPPROVALS = "inventory:request stock_my approvals",
